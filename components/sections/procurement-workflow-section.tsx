...
export function ProcurementWorkflowSection({
  ...
  return (
    <section className="relative bg-brand-onyx text-white py-16 sm:py-24 px-4 sm:px-6 lg:px-8 border-b border-brand-marble/40 overflow-hidden">
      {/* Background Ambient Lighting */}
      <div className="absolute inset-0 bg-radial from-brand-charcoal/50 via-brand-onyx to-brand-onyx pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto w-full space-y-12 sm:space-y-16">
        ...
        {/* 4-Step Process: Circular Step Images, Arrows Between, Text Below (No Cards) */}
            ...
            return (
              ...
              >
                ...
                <div className="relative w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 shrink-0">
                  ...
                  <div className="w-full h-full rounded-full overflow-hidden border-2 border-brand-marble/80 shadow-xl bg-brand-charcoal group-hover:border-blue-400 group-hover:scale-105 transition-all duration-300 relative">
                    <Image
                      src={item.image}
                      alt={item.title}
                      fill
                  ...
                  <div className="absolute bottom-0 right-0 sm:bottom-0.5 sm:right-0.5 w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-brand-charcoal border-2 border-brand-marble flex items-center justify-center text-blue-400 shadow-xl z-20 group-hover:border-blue-400 transition-colors">
                    <IconComponent className="h-4 w-4 sm:h-4.5 sm:w-4.5 text-blue-400" />
                  </div>
                </div>
                ...
                {!isLastStep && (
                  <div className="hidden lg:flex absolute top-14 -right-5 lg:-right-6 -translate-y-1/2 items-center justify-center z-20 pointer-events-none">
                    <ArrowRight className="h-6 w-6 text-slate-400 group-hover:text-blue-400 transition-colors stroke-[2.5]" />
                  </div>
                )}
                ...
                <div className="space-y-3 max-w-xs">
                  {/* Step Number Badge */}
                  <div className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-brand-charcoal border border-brand-marble/60 text-[11px] font-bold uppercase tracking-wider text-slate-300">
